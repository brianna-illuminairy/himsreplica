...
export function QFOption({ children, sub, selected, multi, onClick }) {
...
export function QFChip({ title, sub, selected, onClick }) {
  return (
...
export function QFPill({ children, selected, onClick }) {
  return (
...
export function QFButton({ children, kind = 'ink', onClick, disabled, style }) {
...
export function QFQuestionHead({ eyebrow, title, lead }) {
  return (
...
export function QFOptOut({ children = "None of these — help me figure it out", onClick }) {
  return (
    <button className="qf-opt-out" onClick={onClick}>{children}</button>
  );
}

export function QFWhyWeAsk({ children, source }) {
  return (
